...
| **Connected services** | Product-level integrations catalog on the phone (GitHub via gh skills, Supabase/Fly/… via configured MCP). Host/profile-scoped in v1 — not a skills/MCP tool dump. |
